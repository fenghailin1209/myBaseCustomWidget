 ...
 */
public class MyBehavir extends CoordinatorLayout.Behavior{
     ...
     * @param attrs
     */
    public MyBehavir(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private static final String TAG = MyBehavir.class.getSimpleName();
