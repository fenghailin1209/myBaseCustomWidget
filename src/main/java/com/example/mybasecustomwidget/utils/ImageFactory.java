...
import com.example.mybasecustomwidget.utils.FileUtil;
...
public class ImageFactory {
    ...
    private static final java.lang.String TAG = ImageFactory.class.getSimpleName();
...
//	    return compress(bitmap, maxSize); // 这里再进行质量压缩的意义不大，反而耗资源，删除
    ...
    public static void compressAndGenImage(Bitmap image, String outPath, int maxSize) throws IOException {
        ...
        // Compress by loop
        Log.i(TAG,"--->>>size:"+os.toByteArray().length / 1024);
    ...
    public static int[] ratioAndGenThumbSize(String imgPath, String outPath, float pixelW, float pixelH, boolean needsDelete) throws FileNotFoundException {
        Bitmap bitmap = ratio(imgPath, pixelW, pixelH);

        bitmap = rotateImage(bitmap,imgPath);
    ...
    /**
     * TODO:http://blog.csdn.net/love_techlive/article/details/51365209
     * 部分（三星）手机拍照后照片旋转问题解决方案
     * @param bm
     * @param path
     * @return
     */
    public static Bitmap rotateImage(Bitmap bm,String path){
        ...
        Log.i(TAG,"--->>>rotateImage degree:"+degree);
