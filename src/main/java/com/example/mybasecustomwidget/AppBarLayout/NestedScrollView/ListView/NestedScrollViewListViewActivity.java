 ...
 */
public class NestedScrollViewListViewActivity extends AppCompatActivity{

    private List<com.example.mybasecustomwidget.baseAdapterHelper.multipleSupport.Bean> mDatas = new ArrayList<com.example.mybasecustomwidget.baseAdapterHelper.multipleSupport.Bean>();
...
//        setSupportActionBar(toolbar);
    ...
    private void setListView() {
        ...
        QuickAdapter mAdapter = new QuickAdapter<Bean>(
                NestedScrollViewListViewActivity.this, R.layout.item_list, mDatas) {
            @Override
